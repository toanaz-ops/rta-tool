...
PR #17. Re-measured at `d071269`: **111 hits**, and sixteen files outside
...
**And that moved a gate nobody moved with it.** `app/src/api/ApiSerialise.cpp:74`
...
What the matrix says at `main` `d071269`, reproduced across four consecutive
runs: **ubuntu-latest 774/774** and **windows-latest 774/774** — which is the
...
6. **Now: L6a (SPL-pro)** — SPL logging / history / alarms / PDF / web viewer
   ...
   **station 3 is DONE 2026-09-17** — plan
   ...
   - "the Meters track landed… so the dependency is satisfied" was true of
     ...
     **111**, across sixteen files outside `core/`, and
