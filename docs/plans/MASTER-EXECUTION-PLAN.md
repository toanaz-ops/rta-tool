...
**Open / next: L6a (SPL-pro) stations 1+2+3 are DONE** (1+2 on 2026-09-16,
...
2026-09-18T03:36Z, before PR #18 did.) **Waves 1-4 have not started**; the
L6a row below carries the tallies, the design finding and the three falsified
tolerances. **Corrected 2026-09-18 at the L-API closeout — this paragraph's own
...
graph LR
    ...
    P6["<b>P6</b> · SPL-pro + multichannel<br/><i>L6b BUILT 2026-09-06 · L6a Wave 0 BUILT 2026-09-18, Waves 1-4 next</i>"]
    ...
    class P1,P2,P3,P4,L5a,L5c,P7,LAPI done
    class P6 next
...
6. **Now: L6a (SPL-pro)** — SPL logging / history / alarms / PDF / web viewer
   ...
   **station 3 is DONE 2026-09-17** — plan
   ...
   2026-09-18 (PR #17 at `b1e14a9`); WAVES 1–4 are what is next.** Two
   corrections this item carried, both now paid:
