...
- [A verifier with Bash can git-checkout your uncommitted fix](a-verifier-with-bash-can-git-checkout-your-uncommitted-fix.md) — no Write tool still leaves git; `git checkout -- file` on an uncommitted fix resets it to HEAD; commit before dispatching, and rebuild from the current tree before trusting a reported GREEN.
