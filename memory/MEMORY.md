...
- [Mutation testing needs the exe deleted first](mutation-testing-needs-the-exe-deleted-first.md) — cmake --build can log "-> X.exe" without relinking; a stale binary false-PASSes mutations.
