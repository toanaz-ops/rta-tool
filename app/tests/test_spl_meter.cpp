...
// WEIGHTING/DETECTOR half -- B1, B2, B2b, B5, and the derived histogram base.
// The block-flow/allocation half (B3, B4, the sample-accounting and evicted-
// block cases) split out to test_spl_meter_accounting.cpp (LOW follow-up
// batch, item 4) when this file crossed the 400-line hard cap; the fixtures
// duplicated between the two files are each under 20 lines, the same
// trade-off test_spl_log_pipeline.cpp's own three-way split already makes.
//
